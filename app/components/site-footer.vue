...
<template>
    <footer class="mt-auto bg-violet-950 w-full dark:bg-neutral-950">
        <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                <div class="col-span-1">
                    <h4 class="font-semibold text-gray-100">Nav</h4>

                    <div class="mt-3 grid space-y-3">
                        <p v-for="menu in MENUDATA" :key="menu.label"><a
                                ...
                                :href="menu.to">{{ menu.label }}</a></p>
                    </div>
                </div>
                <!-- End Col -->

                <div class="col-span-1">
                    <h4 class="font-semibold text-gray-100">Who we are?</h4>
                ...
                <div class="col-span-2">
                    <h4 class="font-semibold text-gray-100">Book a Demo Now !</h4>

                    <form>
                        <div
                            class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                            <div class="w-full">
                                <label for="hero-input" class="sr-only">Book a Demo</label>
                                <input id="hero-input" type="text" name="hero-input"
                        ...
                        <p class="mt-3 text-sm text-gray-400">
                            With our demo, see how our software can help you run your
                            pharmacy smoothly.
                        </p>
                    </form>
                </div>
